...
{
    private final Class<Generic> genericClass;
    private final Class<Specific> specificClass;
    private final IVersionedSerializer<Specific> specificSerializer;

    public CastingSerializer(Class<Generic> genericClass, Class<Specific> specificClass, IVersionedSerializer<Specific> specificSerializer)
    {
