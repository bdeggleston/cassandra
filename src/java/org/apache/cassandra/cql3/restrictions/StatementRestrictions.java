...
public final class StatementRestrictions
{
     ...
     */
    public NavigableSet<Clustering<ByteBuffer>> getClusteringColumns(QueryOptions options)
    {
     ...
     */
    public NavigableSet<ClusteringBound<ByteBuffer>> getClusteringColumnsBounds(Bound b, QueryOptions options)
    {
