...
public class SelectStatement implements CQLStatement
{
                    ...
                    for (ColumnDefinition def : selection.getColumns())
                    {
                        switch (def.kind)
                        {
                            case PARTITION_KEY:
                                ...
                                break;
                            case STATIC:
                                addValue(result, def, staticRow, protocolVersion);
                                break;
                            default:
    ...
    private static void addValue(Selection.ResultSetBuilder result, ColumnDefinition def, Row row, int protocolVersion)
    {
        if (def.isComplex())
        {
