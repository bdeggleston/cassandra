...
public class PaxosState
{
    ...
    public static PrepareResponse prepare(Commit toPrepare, Tracing tracing, SystemKeyspace systemKeyspace)
    {
    ...
    public static Boolean propose(Commit proposal, Tracing tracing, SystemKeyspace systemKeyspace)
    {
    ...
    public static void commit(Commit proposal, Tracing tracing, SystemKeyspace systemKeyspace, KeyspaceManager keyspaceManager)
    {
