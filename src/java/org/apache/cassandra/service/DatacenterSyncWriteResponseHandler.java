...
public class DatacenterSyncWriteResponseHandler extends AbstractWriteResponseHandler
{
                                              ...
                                              EndpointIsAlivePredicate endpointIsAlivePredicate)
    {
        ...
        {
            responses.get(this.databaseDescriptor.getEndpointSnitch().getDatacenter(pending)).incrementAndGet();
        }
    }
    ...
    public void response(MessageIn message)
    {
        String dataCenter = message == null
                            ...
                            : databaseDescriptor.getEndpointSnitch().getDatacenter(message.from);
