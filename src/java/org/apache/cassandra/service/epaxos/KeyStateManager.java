...
public class KeyStateManager
{
    ...
    public Pair<Set<UUID>, Range<Token>> getCurrentDependencies(Instance instance)
    {
        ...
        else if (instance.getType() == Instance.Type.EPOCH || instance.getType() == Instance.Type.TOKEN)
        {
            ...
            Pair<Set<UUID>, Range<Token>> result = tokenStateManager.getCurrentDependencies((AbstractTokenInstance) instance);

            deps = new HashSet<>(result.left);
            ...
            Iterator<CfKey> cfKeyIterator = getCfKeyIterator(range, instance.getCfId(), 10000);
