...
public class TokenStateManager
{
    ...
    /**
     * Records the given instance as a dependency, and returns previous
     * dependencies.
     */
    public Pair<Set<UUID>, Range<Token>> getCurrentDependencies(AbstractTokenInstance instance)
    {
        ...
        try
        {
            ...
            save(ts);
            return Pair.create(deps, ts.getRange());
        }
        finally
        {
