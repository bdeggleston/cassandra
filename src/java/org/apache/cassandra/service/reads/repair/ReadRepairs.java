...
public class ReadRepairs
{
    ...
    private static final Logger logger = LoggerFactory.getLogger(ReadRepairs.class);
     ...
     */
    public static Iterable<InetAddressAndPort> getCandidateEndpoints(Keyspace keyspace, DecoratedKey key, ConsistencyLevel consistency)
    {
        List<InetAddressAndPort> endpoints = StorageProxy.getLiveSortedEndpoints(keyspace, key);
