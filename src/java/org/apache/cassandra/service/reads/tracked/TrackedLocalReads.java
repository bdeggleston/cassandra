...
public class TrackedLocalReads implements ExpiredStatePurger.Expireable
{
        ...
        long expiresAtNanos)
    {
        ...
        beginReadInternal(readId, command, replicaPlan, summaryNodes, expiresAtNanos, promise);
        return promise;
    }
        ...
        AsyncPromise<TrackedDataResponse> promise)
    {
        ...
        //                  no nod needs anything from anyone?
                ...
                if (followUp != null)
                {
                    ...
                    followUp.future().addCallback((iterator, error) -> {
                        ...
                        TrackedDataResponse newResponse =
                            TrackedDataResponse.create(PartitionIterators.concat(List.of(previous, iterator)), selection);
