...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    */
    ...
    {
        return DatabaseDescriptor.getPaxosPurgeGraceSeconds();
    }

    public void setPaxosPurgeGraceSeconds(long v)
    {
        DatabaseDescriptor.setPaxosPurgeGraceSeconds(v);
        logger.info("paxos purging grace seconds set to {} via jmx", v);
    }

    public boolean getRejectPaxosLinearizabilityViolations()
    {
        return DatabaseDescriptor.rejectPaxosLinearizabilityViolations();
    }

    public void setRejectPaxosLinearizabilityViolations(boolean enabled)
    {
        DatabaseDescriptor.setRejectPaxosLinearizabilityViolations(enabled);
