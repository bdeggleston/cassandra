...
public abstract class TxnCondition
{
    ...
    public static class Exists extends TxnCondition
    {
        ...
        public String toString()
        {
            return kind.toString() + ' ' + reference.toString();
        }
        ...
        private static ConditionSerializer<Exists> serializer = new ConditionSerializer<>()
        {
            @Override
    ...
    public static class Value extends TxnCondition
    {
        ...
        public String toString()
        {
            return reference.toString() + ' ' + kind.symbol + ' ' + ByteBufferUtil.bytesToHex(value);
        }
