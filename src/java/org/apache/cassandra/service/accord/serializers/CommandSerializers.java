...
public class CommandSerializers
{
    ...
    private static final IVersionedSerializer<Read> read = new CastingSerializer<>(Read.class, TxnRead.class, TxnRead.serializer);
    private static final IVersionedSerializer<Query> query = new CastingSerializer<>(Query.class, TxnQuery.class, TxnQuery.serializer);
    private static final IVersionedSerializer<Update> update = new CastingSerializer<>(Update.class, TxnUpdate.class, TxnUpdate.serializer);
