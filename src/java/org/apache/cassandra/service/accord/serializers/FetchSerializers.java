...
public class FetchSerializers
{
    ...
    public static final IVersionedSerializer<ReadReply> reply = new IVersionedSerializer<ReadReply>()
    {
        ...
        final IVersionedSerializer<Data> streamDataSerializer = new CastingSerializer<>(Data.class, StreamData.class, StreamData.serializer);
        ...
        public void serialize(ReadReply reply, DataOutputPlus out, int version) throws IOException
        {
            ...
            KeySerializers.ranges.serialize(response.unavailable, out, version);
            streamDataSerializer.serialize(response.data, out, version);
        ...
        public ReadReply deserialize(DataInputPlus in, int version) throws IOException
        {
            ...
            return new FetchResponse(KeySerializers.ranges.deserialize(in, version),
                                     streamDataSerializer.deserialize(in, version),
        ...
        public long serializedSize(ReadReply reply, int version)
        {
            ...
            FetchResponse response = (FetchResponse) reply;
            return TypeSizes.BYTE_SIZE
                   + KeySerializers.ranges.serializedSize(response.unavailable, version)
                   + streamDataSerializer.serializedSize(response.data, version)
