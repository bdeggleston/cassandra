...
public abstract class SortedTableScrubber<R extends SSTableReaderWithFilter> implements IScrubber
{
    ...
    public void scrub()
    {
             ...
             Refs<SSTableReader> refs = Refs.ref(Collections.singleton(sstable)))
        {
            ...
            writer.switchWriter(CompactionManager.createWriter(cfs, destination, expectedBloomFilterSize, metadata.repairedAt, metadata.pendingRepair, metadata.isTransient, metadata.mutationIdRanges, sstable, transaction));
    ...
    private SSTableReader writeOutOfOrderPartitions(StatsMetadata metadata)
    {
        ...
        try (SSTableWriter inOrderWriter = CompactionManager.createWriter(cfs, destination, expectedBloomFilterSize, repairedAt, metadata.pendingRepair, metadata.isTransient, metadata.mutationIdRanges, sstable, transaction))
        {
