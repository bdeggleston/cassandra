...
public class RangeAwareSSTableWriter implements SSTableMultiWriter
{
    ...
    private final MutationIdMetadata mutationIdMetadata;
    ...
    public RangeAwareSSTableWriter(ColumnFamilyStore cfs, long estimatedKeys, long repairedAt, TimeUUID pendingRepair, boolean isTransient, MutationIdMetadata mutationIdMetadata, SSTableFormat<?, ?> format, int sstableLevel, long totalSize, LifecycleNewTracker lifecycleNewTracker, SerializationHeader header) throws IOException
    {
        ...
        if (boundaries == null)
        {
            ...
            currentWriter = cfs.createSSTableMultiWriter(desc, estimatedKeys, repairedAt, pendingRepair, isTransient, mutationIdMetadata, null, sstableLevel, header, lifecycleNewTracker);
        }
    }
