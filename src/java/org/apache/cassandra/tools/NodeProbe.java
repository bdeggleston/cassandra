...
import org.apache.cassandra.replication.MutationTrackingMBean;
...
public class NodeProbe implements AutoCloseable
{
    ...
    protected MutationTrackingMBean mutationTrackingProxy;
    ...
    protected void connect() throws IOException
    {
        ...
        try
        {
            ...
            if (mbeanServerConn.isRegistered(name))
                mutationTrackingProxy = JMX.newMBeanProxy(mbeanServerConn, name, MutationTrackingMBean.class);
