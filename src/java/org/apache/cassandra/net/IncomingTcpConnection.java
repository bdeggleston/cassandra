...
public class IncomingTcpConnection extends Thread
{
    ...
    public IncomingTcpConnection(int version, boolean compressed, Socket socket, DatabaseDescriptor databaseDescriptor, Gossiper gossiper, MessagingService messagingService)
    {
        assert socket != null;
        ...
        if (this.databaseDescriptor.getInternodeRecvBufferSize() != null)
        {
            try
            {
                this.socket.setReceiveBufferSize(this.databaseDescriptor.getInternodeRecvBufferSize());
            }
