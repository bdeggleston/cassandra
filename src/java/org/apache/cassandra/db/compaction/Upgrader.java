...
public class Upgrader
{
    ...
    private SSTableWriter createCompactionWriter(long repairedAt)
    {
        ...
        return SSTableWriterFactory.instance.create(cfs.getTempSSTablePath(directory), estimatedRows, repairedAt, cfs.metadata, cfs.partitioner, sstableMetadataCollector);
    }
