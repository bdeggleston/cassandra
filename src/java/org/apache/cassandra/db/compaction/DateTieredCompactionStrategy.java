...
public class DateTieredCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    public synchronized AbstractCompactionTask getNextBackgroundTask(int gcBefore)
    {
        while (true)
        {
            ...
            if (modifier != null)
                return new CompactionTask(csm, modifier, gcBefore);
        }
    }
    ...
    public synchronized Collection<AbstractCompactionTask> getMaximalTask(int gcBefore, boolean splitOutput)
    {
        ...
        return Arrays.<AbstractCompactionTask>asList(new CompactionTask(csm, modifier, gcBefore));
    }
    ...
    public synchronized AbstractCompactionTask getUserDefinedTask(Collection<SSTableReader> sstables, int gcBefore)
    {
        ...
        return new CompactionTask(csm, modifier, gcBefore).setUserDefined(true);
    }
