...
public class DynamicCompositeType extends AbstractCompositeType
{
    ...
    private <V> AbstractType<?> getComparator(V value, DataHandle<V> handle, int offset)
    {
        try
        {
            int header = handle.getShort(value, offset);
    ...
    protected <V> AbstractType<?> validateComparator(int i, V input, DataHandle<V> handle, int offset) throws MarshalException
    {
