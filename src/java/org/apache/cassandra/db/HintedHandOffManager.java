...
public class HintedHandOffManager implements HintedHandOffManagerMBean
{
    ...
    public void start()
    {
        ...
        StorageServiceTasks.instance.optionalTasks.scheduleWithFixedDelay(runnable, 10, 10, TimeUnit.MINUTES);
    }
    ...
    public void deleteHintsForEndpoint(final InetAddress endpoint)
    {
        ...
        StorageServiceTasks.instance.optionalTasks.submit(runnable);
    }
    ...
    public void truncateAllHints() throws ExecutionException, InterruptedException
    {
        ...
        StorageServiceTasks.instance.optionalTasks.submit(runnable).get();
