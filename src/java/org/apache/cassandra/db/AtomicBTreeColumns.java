...
{
    static final long EMPTY_SIZE = ObjectSizes.measure(new AtomicBTreeColumns(new CFMetaData("ks", "cf", ColumnFamilyType.Standard, new SimpleSparseCellNameType(UTF8Type.instance)), null))
