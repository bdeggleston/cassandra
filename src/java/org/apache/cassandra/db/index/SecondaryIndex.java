...
public abstract class SecondaryIndex
{
    ...
    public static final AbstractType<?> keyComparator = ClusterState.instance.getPartitioner().preservesOrder()
                                                      ? BytesType.instance
                                                      : new LocalByPartionerType(ClusterState.instance.getPartitioner());
