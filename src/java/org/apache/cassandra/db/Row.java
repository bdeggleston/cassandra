...
public class Row
{
    ...
    {
        this(ClusterState.instance.getPartitioner().decorateKey(key), updates);
    }
    ...
    public static class RowSerializer implements IVersionedSerializer<Row>
    {
        ...
        {
            return new Row(ClusterState.instance.getPartitioner().decorateKey(ByteBufferUtil.readWithShortLength(in)),
