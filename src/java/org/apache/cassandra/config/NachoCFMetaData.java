...
public class NachoCFMetaData extends CFMetaData
{
    ...
    public NachoCFMetaData(String keyspace, String name, UUID cfId, boolean isSuper, boolean isCounter, boolean isDense, boolean isCompound, List<ColumnDefinition> partitionKeyColumns, List<ColumnDefinition> clusteringColumns, PartitionColumns partitionColumns)
    {
        super(keyspace, name, cfId, isSuper, isCounter, isDense, isCompound, partitionKeyColumns, clusteringColumns, partitionColumns);
    }
