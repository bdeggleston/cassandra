...
public class DatabaseDescriptor
{
    ...
    private void applyConfig() throws ConfigurationException
    {
        ...
        else
        {
            try
            {
                rpcAddress = getListenAddress() == null ? InetAddress.getLocalHost() : getListenAddress();
            }
            catch (UnknownHostException e)
            {
        ...
        List<KSMetaData> systemKeyspaces = Arrays.asList(KSMetaDataFactory.instance.systemKeyspace());
