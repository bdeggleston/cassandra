...
public class Validator implements Runnable
{
    ...
    public void fail()
    {
        ...
        messagingService.sendOneWay(new ValidationComplete(desc, messagingService.repairMessageSerializer).createMessage(messagingService), initiator);
    }
    ...
    public void run()
    {
        ...
        messagingService.sendOneWay(new ValidationComplete(desc, tree, messagingService.repairMessageSerializer).createMessage(messagingService), initiator);
    }
}
