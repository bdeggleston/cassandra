...
public class DynamicEndpointSnitch extends AbstractEndpointSnitch implements ILatencySubscriber, DynamicEndpointSnitchMBean
{
    ...
    public DynamicEndpointSnitch(IEndpointSnitch snitch, String instance, int updateInterval, int resetInterval, double badnessThreshold)
    {
        UPDATE_INTERVAL_IN_MS = updateInterval;
        RESET_INTERVAL_IN_MS = resetInterval;
        ...
        StorageServiceTasks.instance.scheduledTasks.scheduleWithFixedDelay(update, UPDATE_INTERVAL_IN_MS, UPDATE_INTERVAL_IN_MS, TimeUnit.MILLISECONDS);
        StorageServiceTasks.instance.scheduledTasks.scheduleWithFixedDelay(reset, RESET_INTERVAL_IN_MS, RESET_INTERVAL_IN_MS, TimeUnit.MILLISECONDS);
        registerMBean();
   }
