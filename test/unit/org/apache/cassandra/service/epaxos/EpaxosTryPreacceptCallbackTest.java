...
{
    public MessageIn<TryPreacceptResponse> createResponse(InetAddress from, Instance instance, TryPreacceptDecision decision, boolean vetoed)
    {
        TryPreacceptResponse response = new TryPreacceptResponse(instance.getToken(), instance.getCfId(), 0, instance.getId(), decision, vetoed);
    ...
    public void acceptCase()
    {
        ...
        callback.epochResponse(createResponse(state.localEndpoints.get(0), instance, TryPreacceptDecision.ACCEPTED, false));
        Assert.assertFalse(callback.isCompleted());
        callback.epochResponse(createResponse(state.localEndpoints.get(1), instance, TryPreacceptDecision.ACCEPTED, false));
        ...
        Assert.assertFalse(call.decision.vetoed);
    ...
    public void nextAttemptCase()
    {
        ...
        callback.epochResponse(createResponse(state.localEndpoints.get(0), instance, TryPreacceptDecision.REJECTED, false));
        Assert.assertFalse(callback.isCompleted());
        callback.epochResponse(createResponse(state.localEndpoints.get(1), instance, TryPreacceptDecision.REJECTED, false));
        Assert.assertTrue(callback.isCompleted());
    ...
    public void testContended()
    {
        ...
        callback.epochResponse(createResponse(state.localEndpoints.get(0), instance, TryPreacceptDecision.ACCEPTED, false));
        Assert.assertFalse(callback.isCompleted());
        callback.epochResponse(createResponse(state.localEndpoints.get(1), instance, TryPreacceptDecision.CONTENDED, false));
        Assert.assertTrue(callback.isCompleted());
    ...
    public void responseEpochVeto()
    {
        ...
        callback.epochResponse(createResponse(state.localEndpoints.get(0), instance, TryPreacceptDecision.ACCEPTED, true));
        callback.epochResponse(createResponse(state.localEndpoints.get(1), instance, TryPreacceptDecision.ACCEPTED, false));
        Assert.assertTrue(callback.isCompleted());
    ...
    public void ignoreDuplicateAndUninvolvedResponses()
    {
        ...
        callback.epochResponse(createResponse(state.localEndpoints.get(2), instance, TryPreacceptDecision.ACCEPTED, false));
        Assert.assertFalse(callback.isCompleted());
        callback.epochResponse(createResponse(state.localEndpoints.get(1), instance, TryPreacceptDecision.ACCEPTED, false));
        Assert.assertTrue(callback.isCompleted());
    }
