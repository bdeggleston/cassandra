...
public class EpaxosUpgradeServiceRuntimeTest extends AbstractEpaxosTest
{
    ...
    {
        String dml = String.format("INSERT INTO %s.%S (row_key, cf_id) VALUES (?, ?)", Keyspace.SYSTEM_KS, SystemKeyspace.PAXOS_CF);
    ...
    @Test
    public void ringMutation()
    {
        // TODO: this
        // TODO: inactive token states should be resized
    }
}
