...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    private static final Range<Token> FULL_RANGE = new Range<>(StorageService.instance.getPartitioner().getMinimumToken(), StorageService.instance.getPartitioner().getMinimumToken());
