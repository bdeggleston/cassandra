...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    private void testValidationCompleteWrite() throws IOException
    {
        ...
        Validator v0 = new Validator(DESC, databaseDescriptor.getBroadcastAddress(),  -1, databaseDescriptor, databaseDescriptor.getStageManager(), databaseDescriptor.getMessagingService());
        ...
        Validator v1 = new Validator(DESC, databaseDescriptor.getBroadcastAddress(), -1, databaseDescriptor, databaseDescriptor.getStageManager(), databaseDescriptor.getMessagingService());
