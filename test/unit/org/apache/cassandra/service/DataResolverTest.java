...
public class DataResolverTest
{
    ...
    {
        DataResolver resolver = new DataResolver(ks, command, ConsistencyLevel.ALL, 2, System.nanoTime(), NoopReadRepair.instance);
    ...
    {
        DataResolver resolver = new DataResolver(ks, command, ConsistencyLevel.ALL, 4, System.nanoTime(), NoopReadRepair.instance);
    ...
    public void testResolveComplexDelete()
    {
        ...
        DataResolver resolver = new DataResolver(ks, cmd, ConsistencyLevel.ALL, 2, System.nanoTime(), NoopReadRepair.instance);
