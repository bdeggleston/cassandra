...
public class StreamingTransferTest
{
    ...
    public void testEmptyStreamPlan() throws Exception
    {
        StreamResultFuture futureResult = new StreamPlan("StreamingTransferTest", DatabaseDescriptor.instance, Schema.instance,
                                                         KeyspaceManager.instance, StreamManager.instance).execute();
    ...
    {
        new StreamPlan("StreamingTransferTest", DatabaseDescriptor.instance, Schema.instance,
                       KeyspaceManager.instance, StreamManager.instance).transferFiles(LOCAL, makeStreamingDetails(ranges, Arrays.asList(sstable))).execute().get();
    }
    ...
    public void testTransferTableMultiple() throws Exception
    {
        ...
        new StreamPlan("StreamingTransferTest", DatabaseDescriptor.instance, Schema.instance,
                       KeyspaceManager.instance, StreamManager.instance).transferFiles(LOCAL, makeStreamingDetails(ranges, Arrays.asList(sstable, sstable2))).execute().get();
    ...
    public void testTransferOfMultipleColumnFamilies() throws Exception
    {
        ...
        new StreamPlan("StreamingTransferTest", DatabaseDescriptor.instance, Schema.instance,
                       KeyspaceManager.instance, StreamManager.instance).transferFiles(LOCAL, makeStreamingDetails(ranges, ssTableReaders)).execute().get();
