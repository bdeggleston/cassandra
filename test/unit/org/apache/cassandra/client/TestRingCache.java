...
public class TestRingCache
{
    ...
    private void setup(String server, int port) throws Exception
    {
        ...
        String seed = DatabaseDescriptor.createMain(false, false).getSeeds().iterator().next().getHostAddress();
        ...
        ConfigHelper.setOutputRpcPort(conf, Integer.toString(DatabaseDescriptor.createMain(false, false).getRpcPort()));
    ...
    public static void main(String[] args) throws Throwable
    {
        ...
        for (int nRows = minRow; nRows < maxRow; nRows++)
        {
            ...
            tester.setup(firstEndpoint.getHostAddress(), DatabaseDescriptor.createMain(false, false).getRpcPort());
