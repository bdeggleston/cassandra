...
public class GoogleCloudSnitchTest
{
    ...
    public void testRac() throws IOException, ConfigurationException
    {
        ...
        stateMap.put(ApplicationState.DC, ClusterState.instance.valueFactory.datacenter("europe-west1"));
        stateMap.put(ApplicationState.RACK, ClusterState.instance.valueFactory.datacenter("a"));
