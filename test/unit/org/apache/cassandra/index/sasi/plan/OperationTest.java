...
public class OperationTest extends SchemaLoader
{
    ...
    public void testAnalyze() throws Exception
    {
        ...
        Map<Expression.Op, Expression> expressions = convert(Operation.analyzeGroup(controller, OperationType.AND,
                                                                                Arrays.asList(new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)),
                                                                                              new SimpleExpression(age, Operator.GT, Int32Type.instance.decomposeBuffer(1)),
                                                                                              new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(6)),
                                                                                              new SimpleExpression(age, Operator.LTE, Int32Type.instance.decomposeBuffer(10)))));

        Expression expected = new Expression("age", Int32Type.instance)
        {{
            operation = Op.RANGE;
            lower = new Bound(Int32Type.instance.decomposeBuffer(1), false);
            upper = new Bound(Int32Type.instance.decomposeBuffer(10), true);

            exclusions.add(Int32Type.instance.decomposeBuffer(5));
            exclusions.add(Int32Type.instance.decomposeBuffer(6));
        }};
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.OR,
                                                    Arrays.asList(new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)),
                                                                  new SimpleExpression(age, Operator.GTE, Int32Type.instance.decomposeBuffer(7)))));
        Assert.assertEquals(2, expressions.size());

        Assert.assertEquals(new Expression("age", Int32Type.instance)
                            {{
                                    operation = Op.NOT_EQ;
                                    lower = new Bound(Int32Type.instance.decomposeBuffer(5), true);
                                    upper = lower;
        ...
        Assert.assertEquals(new Expression("age", Int32Type.instance)
                            {{
                                    operation = Op.RANGE;
                                    lower = new Bound(Int32Type.instance.decomposeBuffer(7), true);
                            }}, expressions.get(Expression.Op.RANGE));

        // age != 5 OR age < 7
        expressions = convert(Operation.analyzeGroup(controller, OperationType.OR,
                                                    Arrays.asList(new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)),
                                                                  new SimpleExpression(age, Operator.LT, Int32Type.instance.decomposeBuffer(7)))));

        Assert.assertEquals(2, expressions.size());
        Assert.assertEquals(new Expression("age", Int32Type.instance)
                            {{
                                    operation = Op.RANGE;
                                    upper = new Bound(Int32Type.instance.decomposeBuffer(7), false);
                            }}, expressions.get(Expression.Op.RANGE));
        Assert.assertEquals(new Expression("age", Int32Type.instance)
                            {{
                                    operation = Op.NOT_EQ;
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.AND,
                                                    Arrays.asList(new SimpleExpression(age, Operator.GT, Int32Type.instance.decomposeBuffer(1)),
                                                                  new SimpleExpression(age, Operator.LT, Int32Type.instance.decomposeBuffer(7)))));
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.OR,
                                                    Arrays.asList(new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("a")),
                                                                  new SimpleExpression(firstName, Operator.NEQ, UTF8Type.instance.decomposeBuffer("b")))));

        Assert.assertEquals(2, expressions.size());
        Assert.assertEquals(new Expression("first_name", UTF8Type.instance)
                            {{
                                    operation = Op.NOT_EQ;
                                    lower = new Bound(UTF8Type.instance.decomposeBuffer("b"), true);
                                    upper = lower;
                            }}, expressions.get(Expression.Op.NOT_EQ));
        Assert.assertEquals(new Expression("first_name", UTF8Type.instance)
                            {{
                                    operation = Op.EQ;
                                    lower = upper = new Bound(UTF8Type.instance.decomposeBuffer("a"), true);
        ...
        ListMultimap<ColumnMetadata, Expression> e = Operation.analyzeGroup(controller, OperationType.OR,
                                                                            Arrays.asList(new SimpleExpression(comment, Operator.LIKE_MATCHES, UTF8Type.instance.decomposeBuffer("soft eng")),
                                                                  new SimpleExpression(comment, Operator.NEQ, UTF8Type.instance.decomposeBuffer("likes do"))));
        ...
        {{
                ...
                {{
                        operation = Op.MATCH;
                        lower = new Bound(UTF8Type.instance.decomposeBuffer("soft"), true);
                        upper = lower;
                }});
                ...
                {{
                        operation = Op.MATCH;
                        lower = new Bound(UTF8Type.instance.decomposeBuffer("eng"), true);
                        upper = lower;
                }});
                ...
                {{
                        operation = Op.NOT_EQ;
                        lower = new Bound(UTF8Type.instance.decomposeBuffer("likes"), true);
                        upper = lower;
                }});
                ...
                {{
                        operation = Op.NOT_EQ;
                        lower = new Bound(UTF8Type.instance.decomposeBuffer("do"), true);
                        upper = lower;
                }});
        }};
        ...
        e = Operation.analyzeGroup(controller, OperationType.OR,
                        Arrays.asList(new SimpleExpression(comment, Operator.NEQ, UTF8Type.instance.decomposeBuffer("likes do")),
                                      new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("j"))));
        ...
        e = Operation.analyzeGroup(controller, OperationType.OR,
                        Arrays.asList(new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(27)),
                                      new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("j")),
                                      new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(25))));
        ...
        {{
                ...
                {{
                        operation = Op.NOT_EQ;
                        lower = new Bound(Int32Type.instance.decomposeBuffer(27), true);
                        upper = lower;
                }});
                ...
                {{
                        operation = Op.NOT_EQ;
                        lower = new Bound(Int32Type.instance.decomposeBuffer(25), true);
                        upper = lower;
                }});
        }};
    ...
    public void testSatisfiedBy() throws Exception
    {
        ...
        builder = new Operation.Builder(OperationType.AND, controller,
                                        new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)),
                                        new SimpleExpression(age, Operator.GT, Int32Type.instance.decomposeBuffer(1)),
                                        new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(6)),
                                        new SimpleExpression(age, Operator.LTE, Int32Type.instance.decomposeBuffer(10)));
        op = builder.complete();
        ...
        builder = new Operation.Builder(OperationType.OR, controller,
                                        new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(5)),
                                        new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(6)));
        ...
        //builder.add(logical);
        builder.add(new SimpleExpression(age, Operator.GTE, Int32Type.instance.decomposeBuffer(0)));
        builder.add(new SimpleExpression(age, Operator.LT, Int32Type.instance.decomposeBuffer(10)));
        builder.add(new SimpleExpression(age, Operator.NEQ, Int32Type.instance.decomposeBuffer(7)));
        ...
        builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(timestamp, Operator.GTE, LongType.instance.decomposeBuffer(10L)));
        builder.add(new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(5)));
        ...
        builder = new Operation.Builder(OperationType.OR, controller,
                                        new SimpleExpression(timestamp, Operator.GT, LongType.instance.decomposeBuffer(10L)));
        builder.setRight(new Operation.Builder(OperationType.AND, controller,
                                               new SimpleExpression(age, Operator.GT, Int32Type.instance.decomposeBuffer(0)),
        ...
        builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(30)));
        op = builder.complete();
    ...
    public void testAnalyzeNotIndexedButDefinedColumn() throws Exception
    {
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.AND,
                Arrays.asList(new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("a")),
                              new SimpleExpression(height, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)))));
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.AND,
                Arrays.asList(new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("a")),
                              new SimpleExpression(height, Operator.GT, Int32Type.instance.decomposeBuffer(0)),
                              new SimpleExpression(height, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)))));
        ...
        {{
            operation = Op.RANGE;
            lower = new Bound(Int32Type.instance.decomposeBuffer(0), false);
            exclusions.add(Int32Type.instance.decomposeBuffer(5));
        }}, expressions.get(Expression.Op.RANGE));
        ...
        expressions = convert(Operation.analyzeGroup(controller, OperationType.AND,
                Arrays.asList(new SimpleExpression(firstName, Operator.EQ, UTF8Type.instance.decomposeBuffer("a")),
                              new SimpleExpression(height, Operator.NEQ, Int32Type.instance.decomposeBuffer(5)),
                              new SimpleExpression(height, Operator.GTE, Int32Type.instance.decomposeBuffer(0)),
                              new SimpleExpression(height, Operator.LT, Int32Type.instance.decomposeBuffer(10)))));
        ...
        {{
                operation = Op.RANGE;
                lower = new Bound(Int32Type.instance.decomposeBuffer(0), true);
                upper = new Bound(Int32Type.instance.decomposeBuffer(10), false);
                exclusions.add(Int32Type.instance.decomposeBuffer(5));
        }}, expressions.get(Expression.Op.RANGE));
    }
    ...
    public void testSatisfiedByWithMultipleTerms()
    {
        ...
        Operation.Builder builder = new Operation.Builder(OperationType.AND, controller,
                                            new SimpleExpression(comment, Operator.LIKE_CONTAINS, UTF8Type.instance.decomposeBuffer("eng is a work")));
        Operation op = builder.complete();

        Assert.assertTrue(op.satisfiedBy(row, staticRow, false));

        builder = new Operation.Builder(OperationType.AND, controller,
                                            new SimpleExpression(comment, Operator.LIKE_CONTAINS, UTF8Type.instance.decomposeBuffer("soft works fine")));
        op = builder.complete();
    ...
    public void testSatisfiedByWithClustering()
    {
        ...
        Operation.Builder builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(27)));
        builder.add(new SimpleExpression(height, Operator.EQ, Int32Type.instance.decomposeBuffer(182)));

        Assert.assertTrue(builder.complete().satisfiedBy(row, staticRow, false));

        builder = new Operation.Builder(OperationType.AND, controller);

        builder.add(new SimpleExpression(age, Operator.EQ, Int32Type.instance.decomposeBuffer(28)));
        builder.add(new SimpleExpression(height, Operator.EQ, Int32Type.instance.decomposeBuffer(182)));

        Assert.assertFalse(builder.complete().satisfiedBy(row, staticRow, false));

        builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(location, Operator.EQ, UTF8Type.instance.decomposeBuffer("US")));
        builder.add(new SimpleExpression(age, Operator.GTE, Int32Type.instance.decomposeBuffer(27)));

        Assert.assertTrue(builder.complete().satisfiedBy(row, staticRow, false));

        builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(location, Operator.EQ, UTF8Type.instance.decomposeBuffer("BY")));
        builder.add(new SimpleExpression(age, Operator.GTE, Int32Type.instance.decomposeBuffer(28)));

        Assert.assertFalse(builder.complete().satisfiedBy(row, staticRow, false));

        builder = new Operation.Builder(OperationType.AND, controller);
        builder.add(new SimpleExpression(location, Operator.EQ, UTF8Type.instance.decomposeBuffer("US")));
        builder.add(new SimpleExpression(age, Operator.LTE, Int32Type.instance.decomposeBuffer(27)));
        builder.add(new SimpleExpression(height, Operator.GTE, Int32Type.instance.decomposeBuffer(182)));
        ...
        builder.add(new SimpleExpression(location, Operator.EQ, UTF8Type.instance.decomposeBuffer("US")));
        builder.add(new SimpleExpression(height, Operator.GTE, Int32Type.instance.decomposeBuffer(182)));
        builder.add(new SimpleExpression(score, Operator.EQ, DoubleType.instance.decomposeBuffer(1.0d)));
    ...
    public void testSatisfiedByWithStatic()
    {
        ...
        Operation op = new Operation.Builder(OperationType.AND, controller,
                                        new SimpleExpression(sensorType, Operator.EQ, UTF8Type.instance.decomposeBuffer("TEMPERATURE")),
                                        new SimpleExpression(value, Operator.EQ, DoubleType.instance.decomposeBuffer(24.56))).complete();
        ...
        op = new Operation.Builder(OperationType.AND, controller,
                                             new SimpleExpression(sensorType, Operator.EQ, UTF8Type.instance.decomposeBuffer("TEMPERATURE")),
                                             new SimpleExpression(value, Operator.EQ, DoubleType.instance.decomposeBuffer(30.00))).complete();
        ...
        op = new Operation.Builder(OperationType.AND, controller,
                                   new SimpleExpression(sensorType, Operator.EQ, UTF8Type.instance.decomposeBuffer("PRESSURE")),
                                   new SimpleExpression(value, Operator.EQ, DoubleType.instance.decomposeBuffer(30.00))).complete();
        ...
        op = new Operation.Builder(OperationType.AND, controller,
                                   new SimpleExpression(sensorType, Operator.LIKE_PREFIX, UTF8Type.instance.decomposeBuffer("TEMP")),
                                   new SimpleExpression(value, Operator.EQ, DoubleType.instance.decomposeBuffer(24.56))).complete();
