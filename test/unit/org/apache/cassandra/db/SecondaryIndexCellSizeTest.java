...
public class SecondaryIndexCellSizeTest
{
    ...
    public void test64kColumn()
    {
        ...
        SecondaryIndexCellSizeTest.MockRowIndex mockRowIndex = new SecondaryIndexCellSizeTest.MockRowIndex(databaseDescriptor.getSystemKeyspace(), databaseDescriptor.getCompactionManager(), databaseDescriptor.getStorageService(), databaseDescriptor.getDBConfig());
        SecondaryIndexCellSizeTest.MockColumnIndex mockColumnIndex = new SecondaryIndexCellSizeTest.MockColumnIndex(databaseDescriptor.getSystemKeyspace(), databaseDescriptor.getCompactionManager(), databaseDescriptor.getStorageService(), databaseDescriptor.getDBConfig());
