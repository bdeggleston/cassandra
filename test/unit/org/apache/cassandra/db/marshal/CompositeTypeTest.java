...
public class CompositeTypeTest
{
    ...
    public void testFullRound() throws Exception
    {
        ...
        ColumnFamily cf = cfs.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("k", databaseDescriptor), CF_STANDARDCOMPOSITE, System.currentTimeMillis(), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
