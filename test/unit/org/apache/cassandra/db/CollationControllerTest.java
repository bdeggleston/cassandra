...
public class CollationControllerTest
{
    ...
    public void getTopLevelColumnsSkipsSSTablesModifiedBeforeRowDelete() 
    {
        ...
        filter = QueryFilter.getIdentityFilter(dk, cfs.name, System.currentTimeMillis(), DatabaseDescriptor.createMain(false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void ensureTombstonesAppliedAfterGCGS()
    {
        ...
        filter = QueryFilter.getIdentityFilter(dk, cfs.name, queryAt, DatabaseDescriptor.createMain(false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
