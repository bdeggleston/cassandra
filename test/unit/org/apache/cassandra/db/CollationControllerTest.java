...
public class CollationControllerTest
{
    ...
    public void getTopLevelColumnsSkipsSSTablesModifiedBeforeRowDelete() 
    {
        ...
        CollationController controller = new CollationController(cfs, filter, Integer.MIN_VALUE, DBConfig.instance, KeyspaceManager.instance, Tracing.instance, MutationFactory.instance);
        ...
        controller = new CollationController(cfs, filter, Integer.MIN_VALUE, DBConfig.instance, KeyspaceManager.instance, Tracing.instance, MutationFactory.instance);
        controller.getTopLevelColumns(true);
    ...
    public void ensureTombstonesAppliedAfterGCGS()
    {
        ...
        CollationController controller = new CollationController(cfs, filter, gcBefore, DBConfig.instance, KeyspaceManager.instance, Tracing.instance, MutationFactory.instance);
        ...
        controller = new CollationController(cfs, filter, gcBefore, DBConfig.instance, KeyspaceManager.instance, Tracing.instance, MutationFactory.instance);
        assert ColumnFamilyStore.removeDeleted(controller.getTopLevelColumns(true), gcBefore) == null;
    }
}
