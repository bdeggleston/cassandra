...
public class RangeTombstoneTest
{
    ...
    public void simpleQueryWithRangeTombstoneTest() throws Exception
    {
        ...
        for (int i : dead)
            columns.add(b(i));
        cf = cfs.getColumnFamily(QueryFilter.getNamesFilter(dk(key), CFNAME, columns, System.currentTimeMillis(), databaseDescriptor.getDBConfig()));
    ...
    public void test7810() throws ExecutionException, InterruptedException, IOException
    {
        ...
        assertEquals(8, Util.getColumnFamily(ks, Util.dk(key), CFNAME, databaseDescriptor).getColumnCount());
    }
    ...
    public void test7808_2() throws ExecutionException, InterruptedException, IOException
    {
        ...
        Thread.sleep(5);
        cfs.forceMajorCompaction();
        assertEquals(1, Util.getColumnFamily(ks, Util.dk(key), CFNAME, databaseDescriptor).getColumnCount());
    }
    ...
    public void overlappingRangeTest() throws Exception
    {
        ...
        cf = cfs.getColumnFamily(QueryFilter.getIdentityFilter(dk(key), CFNAME, System.currentTimeMillis(), DatabaseDescriptor.instance, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
