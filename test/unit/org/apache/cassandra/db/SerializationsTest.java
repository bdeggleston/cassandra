...
public class SerializationsTest extends AbstractSerializationsTester
{
    ...
    public SliceQueryFilter emptyRangePred = new SliceQueryFilter(emptyCol, emptyCol, false, 100, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    public SliceQueryFilter nonEmptyRangePred = new SliceQueryFilter(CellNames.simpleDense(startCol), CellNames.simpleDense(stopCol), true, 100, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    public SliceQueryFilter nonEmptyRangeSCPred = new SliceQueryFilter(CellNames.compositeDense(statics.SC, startCol), CellNames.compositeDense(statics.SC, stopCol), true, 100, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    public SliceByNamesReadCommand.Serializer slicesByNamesSerializer = new SliceByNamesReadCommand.Serializer(databaseDescriptor, databaseDescriptor.getSchema(), databaseDescriptor.getLocatorConfig().getPartitioner(), databaseDescriptor.getMessagingService().readCommandSerializer);
    public SliceFromReadCommand.Serializer slicefromReadSerializer = new SliceFromReadCommand.Serializer(databaseDescriptor, databaseDescriptor.getSchema(), databaseDescriptor.getLocatorConfig().getPartitioner(), databaseDescriptor.getMessagingService().readCommandSerializer);
    ...
    private void testRangeSliceCommandWrite() throws IOException
    {
        ...
        RangeSliceCommand namesCmd = new RangeSliceCommand(statics.KS, "Standard1", statics.readTs, namesPred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
        MessageOut<RangeSliceCommand> namesCmdMsg = namesCmd.createMessage(databaseDescriptor.getMessagingService());
        RangeSliceCommand emptyRangeCmd = new RangeSliceCommand(statics.KS, "Standard1", statics.readTs, emptyRangePred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
        MessageOut<RangeSliceCommand> emptyRangeCmdMsg = emptyRangeCmd.createMessage(databaseDescriptor.getMessagingService());
        RangeSliceCommand regRangeCmd = new RangeSliceCommand(statics.KS, "Standard1", statics.readTs, nonEmptyRangePred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
        MessageOut<RangeSliceCommand> regRangeCmdMsg = regRangeCmd.createMessage(databaseDescriptor.getMessagingService());
        RangeSliceCommand namesCmdSup = new RangeSliceCommand(statics.KS, "Super1", statics.readTs, namesSCPred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
        MessageOut<RangeSliceCommand> namesCmdSupMsg = namesCmdSup.createMessage(databaseDescriptor.getMessagingService());
        RangeSliceCommand emptyRangeCmdSup = new RangeSliceCommand(statics.KS, "Super1", statics.readTs, emptyRangePred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
        MessageOut<RangeSliceCommand> emptyRangeCmdSupMsg = emptyRangeCmdSup.createMessage(databaseDescriptor.getMessagingService());
        RangeSliceCommand regRangeCmdSup = new RangeSliceCommand(statics.KS, "Super1", statics.readTs, nonEmptyRangeSCPred, bounds, 100, databaseDescriptor, databaseDescriptor.getKeyspaceManager(), serializer);
    ...
    public void testRangeSliceCommandRead() throws IOException
    {
        ...
        for (int i = 0; i < 6; i++)
            MessageIn.read(in, getVersion(), -1, databaseDescriptor, databaseDescriptor.getMessagingService());
        in.close();
    }
    ...
    private void testSliceByNamesReadCommandWrite() throws IOException
    {
        ...
        SliceByNamesReadCommand superCmd = new SliceByNamesReadCommand(statics.KS,
                                                                       ...
                                                                       statics.SuperCF,
                                                                       statics.readTs,
                                                                       namesSCPred, databaseDescriptor,
                                                                       databaseDescriptor.getSchema(),
                                                                       databaseDescriptor.getLocatorConfig().getPartitioner(),
                                                                       databaseDescriptor.getMessagingService().readCommandSerializer);
    ...
    public void testSliceByNamesReadCommandRead() throws IOException
    {
        ...
        assert databaseDescriptor.getMessagingService().readCommandSerializer.deserialize(in, getVersion()) != null;
        assert MessageIn.read(in, getVersion(), -1, databaseDescriptor, databaseDescriptor.getMessagingService()) != null;
        assert MessageIn.read(in, getVersion(), -1, databaseDescriptor, databaseDescriptor.getMessagingService()) != null;
        in.close();
    }
    ...
    private void testSliceFromReadCommandWrite() throws IOException
    {
        SliceFromReadCommand standardCmd = new SliceFromReadCommand(statics.KS,
                                                                    ...
                                                                    statics.StandardCF,
                                                                    statics.readTs,
                                                                    nonEmptyRangePred, databaseDescriptor,
                                                                    databaseDescriptor.getSchema(),
                                                                    databaseDescriptor.getLocatorConfig().getPartitioner(),
                                                                    databaseDescriptor.getMessagingService().readCommandSerializer);
        SliceFromReadCommand superCmd = new SliceFromReadCommand(statics.KS,
                                                                 ...
                                                                 statics.SuperCF,
                                                                 statics.readTs,
                                                                 nonEmptyRangeSCPred, databaseDescriptor,
                                                                 databaseDescriptor.getSchema(),
                                                                 databaseDescriptor.getLocatorConfig().getPartitioner(),
                                                                 databaseDescriptor.getMessagingService().readCommandSerializer);
    ...
    public void testTruncateRead() throws IOException
    {
        ...
        assert MessageIn.read(in, getVersion(), 1, databaseDescriptor, databaseDescriptor.getMessagingService()) != null;
        assert MessageIn.read(in, getVersion(), 2, databaseDescriptor, databaseDescriptor.getMessagingService()) != null;
        in.close();
    }
    ...
    private static class Statics
    {
        ...
        private final SortedSet<CellName> NamedCols = new TreeSet<CellName>(new SimpleDenseCellNameType(BytesType.instance, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()))
        {{
        ...
        private final SortedSet<CellName> NamedSCCols = new TreeSet<CellName>(new CompoundDenseCellNameType(Arrays.<AbstractType<?>>asList(BytesType.instance, BytesType.instance), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()))
        {{
