...
public class RowsTest
{
    ...
    private static final byte[] BB1 = ByteArrayUtil.bytes(1);
    private static final byte[] BB2 = ByteArrayUtil.bytes(2);
    private static final byte[] BB3 = ByteArrayUtil.bytes(3);
    private static final byte[] BB4 = ByteArrayUtil.bytes(4);
    ...
    private static Row.Builder createBuilder(Clustering c, int now, byte[] vVal, byte[] mKey, byte[] mVal)
    {
    ...
    private static Cell liveCell(ColumnMetadata name, int path)
    {
        ...
        return new BufferCell(name, 0L, Cell.NO_TTL, Cell.NO_DELETION_TIME, new byte[1], cp);
    }
