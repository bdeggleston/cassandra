...
public class CassandraEntireSSTableStreamWriterTest
{
    ...
    public void testBlockReadingAndWritingOverWire() throws Throwable
    {
             ...
             ComponentContext context = ComponentContext.create(sstable))
        {
            ...
            CassandraEntireSSTableStreamReader reader = new CassandraEntireSSTableStreamReader(new StreamMessageHeader(sstable.metadata().id, peer, session.planId(), false, 0, 0, 0, null, MutationIdMetadata.NONE), header, session);
