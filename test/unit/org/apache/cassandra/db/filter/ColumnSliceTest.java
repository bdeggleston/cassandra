...
public class ColumnSliceTest
{
    ...
    private static final CellNameType simpleIntType = new SimpleDenseCellNameType(Int32Type.instance, DatabaseDescriptor.createMain(false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testIntersectsSingleSlice()
    {
        ...
        types.add(Int32Type.instance);
        types.add(Int32Type.instance);
        CompoundDenseCellNameType nameType = new CompoundDenseCellNameType(types, DatabaseDescriptor.createMain(false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
