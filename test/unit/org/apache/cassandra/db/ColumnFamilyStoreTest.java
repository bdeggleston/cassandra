...
public class ColumnFamilyStoreTest
{
    ...
    public void testGetColumnWithWrongBF()
    {
        ...
        ColumnFamily cf = cfs.getColumnFamily(QueryFilter.getIdentityFilter(Util.dk("key2", databaseDescriptor), CF_STANDARD1, System.currentTimeMillis(), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
        assertNull(cf);
    }
        ...
        Runnable r = new WrappedRunnable()
        {
            public void runMayThrow() throws IOException
            {
                QueryFilter sliceFilter = QueryFilter.getSliceFilter(Util.dk("key1", databaseDescriptor), CF_STANDARD2, Composites.EMPTY, Composites.EMPTY, false,
                                                                     1, System.currentTimeMillis(), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testIndexScan()
    {
        ...
        IDiskAtomFilter filter = new IdentityQueryFilter(databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        ...
        SliceQueryFilter emptyFilter = new SliceQueryFilter(Composites.EMPTY, Composites.EMPTY, false, 0, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testDeleteOfInconsistentValuesInKeysIndex() throws Exception
    {
        ...
        clause = Arrays.asList(expr);
        filter = new IdentityQueryFilter(databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testCassandra6778() throws CharacterCodingException
    {
        ...
        SliceByNamesReadCommand cmd = new SliceByNamesReadCommand(
            ...
            new NamesQueryFilter(FBUtilities.singleton(column1, cfs.getComparator()), databaseDescriptor.getDBConfig()), databaseDescriptor,
        ...
        cmd = new SliceByNamesReadCommand(
            KEYSPACE1, ByteBufferUtil.bytes("k1"), cfname, System.currentTimeMillis(),
            new NamesQueryFilter(FBUtilities.singleton(column2, cfs.getComparator()), databaseDescriptor.getDBConfig()), databaseDescriptor,
            databaseDescriptor.getSchema(),
            databaseDescriptor.getLocatorConfig().getPartitioner(),
            databaseDescriptor.getMessagingService().readCommandSerializer);
    ...
    public void testDeleteSuperRowSticksAfterFlush() throws Throwable
    {
        ...
        assertRowAndColCount(1, 6, false, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, scfName, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
        ...
        // verify delete.
        assertRowAndColCount(1, 0, false, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, scfName, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
        ...
        assertRowAndColCount(1, 3, false, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, scfName, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
    }
    ...
    public void testDeleteStandardRowSticksAfterFlush() throws Throwable
    {
        ...
        assertRowAndColCount(1, 2, false, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
        ...
        assertRowAndColCount(1, 4, false, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
        ...
        // verify delete
        assertRowAndColCount(1, 0, true, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
        ...
        assertRowAndColCount(1, 2, true, cfs.getRangeSlice(Util.range("f", "g", databaseDescriptor), null, ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 100));
    ...
    public void testSliceByNamesCommandOnUUIDTypeSCF() throws Throwable
    {
        ...
        ColumnFamily cfGet = cfs.getColumnFamily(QueryFilter.getIdentityFilter(key, cfName, System.currentTimeMillis(), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
        ...
        SliceByNamesReadCommand cmd = new SliceByNamesReadCommand(keyspaceName,
                                                                  ...
                                                                  new NamesQueryFilter(sliceColNames, databaseDescriptor.getDBConfig()), databaseDescriptor,
                                                                  databaseDescriptor.getSchema(),
                                                                  databaseDescriptor.getLocatorConfig().getPartitioner(),
                                                                  databaseDescriptor.getMessagingService().readCommandSerializer);
    ...
    public void testSliceByNamesCommandOldMetadata() throws Throwable
    {
        ...
        SliceByNamesReadCommand cmd = new SliceByNamesReadCommand(keyspaceName,
                                                                  ...
                                                                  cfName,
                                                                  System.currentTimeMillis(),
                                                                  new NamesQueryFilter(FBUtilities.singleton(cname, cfs.getComparator()), databaseDescriptor.getDBConfig()), databaseDescriptor,
                                                                  databaseDescriptor.getSchema(),
                                                                  databaseDescriptor.getLocatorConfig().getPartitioner(),
                                                                  databaseDescriptor.getMessagingService().readCommandSerializer);
        ColumnFamily cf = cmd.getRow(keyspace).cf;
    ...
    private static void assertTotalColCount(Collection<Row> rows, int expectedCount)
    {
        ...
        for (Row row : rows)
        {
            columns += row.getLiveCount(new SliceQueryFilter(ColumnSlice.ALL_COLUMNS_ARRAY, false, expectedCount, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), System.currentTimeMillis());
        }
    ...
    public void testRangeSliceColumnsLimit() throws Throwable
    {
        ...
        assertTotalColCount(cfs.getRangeSlice(Util.range("", "", databaseDescriptor),
                                              null,
                                              ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()),
                                              3,
                                              System.currentTimeMillis(),
                                              true,
                                              false),
    ...
    public void testRangeSlicePaging() throws Throwable
    {
        ...
        Collection<Row> rows;
        Row row, row1, row2;
        IDiskAtomFilter filter = ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        ...
        filter = ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testRangeSliceInclusionExclusion() throws Throwable
    {
        ...
        sp.getSlice_range().setStart(ArrayUtils.EMPTY_BYTE_ARRAY);
        sp.getSlice_range().setFinish(ArrayUtils.EMPTY_BYTE_ARRAY);
        IDiskAtomFilter qf = ThriftValidation.asIFilter(sp, cfs.metadata, null, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testKeysSearcher() throws Exception
    {
        ...
        List<Row> rows = store.search(store.makeExtendedFilter(Util.range("", "", databaseDescriptor), new IdentityQueryFilter(databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), Arrays.asList(expr), 10, true, false, System.currentTimeMillis()));
    ...
    public void testMultiRangeSomeEmptyNoIndex() throws Throwable
    {
        ...
        SliceQueryFilter multiRangeForward = new SliceQueryFilter(ranges, false, 100, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        SliceQueryFilter multiRangeForwardWithCounting = new SliceQueryFilter(ranges, false, 3, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        SliceQueryFilter multiRangeReverse = new SliceQueryFilter(rangesReversed, true, 100, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        SliceQueryFilter multiRangeReverseWithCounting = new SliceQueryFilter(rangesReversed, true, 3, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    public void testRemoveUnfinishedCompactionLeftovers() throws Throwable
    {
        ...
        Directories dir = new Directories(cfmeta, databaseDescriptor, databaseDescriptor.getStorageService(), databaseDescriptor.getKeyspaceManager(), databaseDescriptor.getColumnFamilyStoreManager().dataDirectories);
    ...
    public void testLoadNewSSTablesAvoidsOverwrites() throws Throwable
    {
        ...
        final CFMetaData cfmeta = databaseDescriptor.getSchema().getCFMetaData(ks, cf);
        Directories dir = new Directories(cfs.metadata, databaseDescriptor, databaseDescriptor.getStorageService(), databaseDescriptor.getKeyspaceManager(), databaseDescriptor.getColumnFamilyStoreManager().dataDirectories);
    ...
    private void testMultiRangeSlicesBehavior(ColumnFamilyStore cfs)
    {
        ...
        SliceQueryFilter startOnlyFilter = new SliceQueryFilter(startOnlyRange, false,
                Integer.MAX_VALUE, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        ...
        SliceQueryFilter startOnlyFilterWithCounting = new SliceQueryFilter(startOnlyRange, false, 1,
                                                                            databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        SliceQueryFilter startOnlyFilterReversedWithCounting = new SliceQueryFilter(startOnlyRangeReversed,
                true, 1, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
        ...
        SliceQueryFilter startMiddleAndEndFilterWithCounting = new SliceQueryFilter(startMiddleAndEndRanges, false,
                1, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
    ...
    private void printRow(ColumnFamilyStore cfs, String rowKey, Collection<Cell> cols)
    {
        ...
        ColumnFamily cf = cfs.getColumnFamily(QueryFilter.getIdentityFilter(ROW, CF_STANDARD1, System.currentTimeMillis(), databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
