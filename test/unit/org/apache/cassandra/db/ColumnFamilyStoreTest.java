...
public class ColumnFamilyStoreTest
{
    ...
    public void testRemoveUnfinishedCompactionLeftovers() throws Throwable
    {
        ...
        Directories dir = new Directories(cfmeta, DatabaseDescriptor.instance, StorageService.instance);
        ...
        Map<Pair<String, String>, Map<Integer, UUID>> unfinished = SystemKeyspace.instance.getUnfinishedCompactions();
    ...
    public void testLoadNewSSTablesAvoidsOverwrites() throws Throwable
    {
        ...
        final CFMetaData cfmeta = Schema.instance.getCFMetaData(ks, cf);
        Directories dir = new Directories(cfs.metadata, DatabaseDescriptor.instance, StorageService.instance);
