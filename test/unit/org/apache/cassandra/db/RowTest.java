...
public class RowTest
{
    ...
    {
        PartitionUpdate update1 = new PartitionUpdate(cfm, dk, cfm.partitionColumns(), 1, nowInSeconds);
        ...
        PartitionUpdate update2 = new PartitionUpdate(cfm, dk, cfm.partitionColumns(), 1, nowInSeconds);
        ...
        try (UnfilteredRowIterator merged = UnfilteredRowIterators.merge(ImmutableList.of(update1.unfilteredIterator(), update2.unfilteredIterator())))
        {
            ...
            {
                RangeTombstoneMarker openMarker = (RangeTombstoneMarker)merged.next();
    ...
    public void testResolve()
    {
        ...
        PartitionUpdate update = new PartitionUpdate(cfm, dk, cfm.partitionColumns(), 1, nowInSeconds);
    ...
    public void writeRangeTombstone(PartitionUpdate update, Object start, Object end, long markedForDeleteAt, int localDeletionTime)
    {
        ...
        update.addRangeTombstone(Slice.make(cfm.comparator, comparator.make(start), comparator.make(end)),
