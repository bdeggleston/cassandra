...
public class CompactionAwareWriterTest extends CQLTester
{
    ...
    public void testDefaultCompactionWriter() throws Throwable
    {
        ...
        CompactionAwareWriter writer = new DefaultCompactionWriter(new CompactionStrategyManager(cfs), txn, txn.originals());
    ...
    public void testMaxSSTableSizeWriter() throws Throwable
    {
        ...
        CompactionAwareWriter writer = new MaxSSTableSizeWriter(new CompactionStrategyManager(cfs), txn, txn.originals(), sstableSize, 0);
        int rows = compact(cfs, txn, writer);
    ...
    public void testMajorLeveledCompactionWriter() throws Throwable
    {
        ...
        CompactionAwareWriter writer = new MajorLeveledCompactionWriter(new CompactionStrategyManager(cfs), txn, txn.originals(), sstableSize);
        int rows = compact(cfs, txn, writer);
