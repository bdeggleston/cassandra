...
public class TTLExpiryTest
{
    ...
    public void testNoExpire() throws InterruptedException
    {
        ...
        SSTableScanner scanner = sstable.getScanner(DataRange.allData(sstable.partitioner, DatabaseDescriptor.instance, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
