...
public class TTLExpiryTest
{
    ...
    public void testSimpleExpire() throws InterruptedException
    {
        ...
        Mutation rm = databaseDescriptor.getMutationFactory().create(KEYSPACE1, Util.dk("ttl", databaseDescriptor).getKey());
        ...
        rm = databaseDescriptor.getMutationFactory().create(KEYSPACE1, Util.dk("ttl", databaseDescriptor).getKey());
    ...
    public void testNoExpire() throws InterruptedException
    {
        ...
        rm.applyUnsafe();
        cfs.forceBlockingFlush();
        DecoratedKey noTTLKey = Util.dk("nottl", databaseDescriptor);
        ...
        SSTableScanner scanner = sstable.getScanner(DataRange.allData(sstable.partitioner, DatabaseDescriptor.createMain(false, false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()));
