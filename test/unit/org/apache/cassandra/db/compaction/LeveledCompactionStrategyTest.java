...
public class LeveledCompactionStrategyTest
{
    ...
    public void testValidationMultipleSSTablePerLevel() throws Exception
    {
        ...
        Validator validator = new Validator(desc, databaseDescriptor.getBroadcastAddress(), gcBefore, databaseDescriptor, databaseDescriptor.getStageManager(), databaseDescriptor.getMessagingService());
