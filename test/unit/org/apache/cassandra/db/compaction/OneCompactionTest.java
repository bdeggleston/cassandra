...
public class OneCompactionTest
{
    ...
    private void testCompaction(String columnFamilyName, int insertsPerTable) throws ExecutionException, InterruptedException
    {
        ...
        for (int j = 0; j < insertsPerTable; j++) {
            DecoratedKey key = Util.dk(String.valueOf(j), databaseDescriptor);
            ...
            assertEquals(inserted.size(), Util.getRangeSlice(store, DatabaseDescriptor.instance, databaseDescriptor.getTracing()).size());
        }
