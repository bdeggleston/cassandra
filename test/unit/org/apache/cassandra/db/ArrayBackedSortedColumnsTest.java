...
public class ArrayBackedSortedColumnsTest
{
    ...
    {
        CellNameType type = new SimpleDenseCellNameType(Int32Type.instance, DatabaseDescriptor.createMain(false), databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig());
