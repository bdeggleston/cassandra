...
public class ReadMessageTest
{
    ...
    {
        CellNameType type = databaseDescriptor.getKeyspaceManager().open(KEYSPACE1).getColumnFamilyStore("Standard1").getComparator();
        ...
        rm = new SliceByNamesReadCommand(KEYSPACE1,
                                         ...
                                         "Standard1",
                                         ts,
                                         new NamesQueryFilter(colList, databaseDescriptor.getDBConfig()), databaseDescriptor,
        ...
        rm = new SliceFromReadCommand(KEYSPACE1,
                                      ...
                                      "Standard1",
                                      ts,
                                      new SliceQueryFilter(Composites.EMPTY, Composites.EMPTY, true, 2, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), databaseDescriptor,
                                      databaseDescriptor.getSchema(),
                                      databaseDescriptor.getLocatorConfig().getPartitioner(),
                                      databaseDescriptor.getMessagingService().readCommandSerializer);
        rm2 = serializeAndDeserializeReadMessage(rm);
        ...
        rm = new SliceFromReadCommand(KEYSPACE1,
                                      ...
                                      "Standard1",
                                      ts,
                                      new SliceQueryFilter(Util.cellname("a"), Util.cellname("z"), true, 5, databaseDescriptor, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), databaseDescriptor,
                                      databaseDescriptor.getSchema(),
                                      databaseDescriptor.getLocatorConfig().getPartitioner(),
                                      databaseDescriptor.getMessagingService().readCommandSerializer);
        rm2 = serializeAndDeserializeReadMessage(rm);
