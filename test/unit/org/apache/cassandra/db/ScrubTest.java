...
public class ScrubTest
{
    ...
    public void testScrubOneRow() throws ExecutionException, InterruptedException
    {
        ...
        fillCF(cfs, 1);
        rows = cfs.getRangeSlice(Util.range("", "", databaseDescriptor), null, new IdentityQueryFilter(DatabaseDescriptor.instance, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 1000);
    ...
    public void testScrubCorruptedCounterRow() throws IOException, WriteTimeoutException
    {
        ...
        List<Row> rows = cfs.getRangeSlice(Util.range("", "", databaseDescriptor), null, new IdentityQueryFilter(DatabaseDescriptor.instance, databaseDescriptor.getTracing(), databaseDescriptor.getDBConfig()), 1000);
