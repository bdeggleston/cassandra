...
public abstract class CQLTester
{
    ...
    public void afterTest() throws Throwable
    {
        ...
        DatabaseDescriptor.instance.getStorageServiceExecutors().optionalTasks.execute(new Runnable()
        {
            public void run()
            {
                try
                {
                    ...
                    DatabaseDescriptor.instance.getStorageServiceExecutors().tasks.execute(new Runnable()
                    {
                            public void run()
                            {
                                latch.countDown();
    ...
    {
        // We could partly rely on QueryProcessor.instance.executeOnceInternal doing type conversion for us, but
