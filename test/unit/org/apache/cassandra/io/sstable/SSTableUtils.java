    ...
    */
    ...
    public static class Context
    {
        ...
        public Collection<SSTableReader> write(int expectedSize, Appender appender) throws IOException
        {
            ...
            SSTableTxnWriter writer = SSTableTxnWriter.create(cfs, Descriptor.fromFileWithComponent(datafile, false).left, expectedSize, UNREPAIRED_SSTABLE, NO_PENDING_REPAIR, false, MutationIdMetadata.NONE, header);
