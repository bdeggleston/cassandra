...
public class SSTableLoaderTest
{
    ...
    public void testLoadingSSTable() throws Exception
    {
        ...
        List<Row> rows = Util.getRangeSlice(KeyspaceManager.instance.open(KEYSPACE1).getColumnFamilyStore(CF_STANDARD), DatabaseDescriptor.instance, Tracing.instance);
