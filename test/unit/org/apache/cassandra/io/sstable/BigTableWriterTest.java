...
public class BigTableWriterTest extends AbstractTransactionalTest
{
    ...
    private static class TestableBTW extends TestableTransaction
    {
        ...
        {
            this(desc, SSTableTxnWriter.create(cfs, desc, 0, 0, null, false, new SerializationHeader(true, cfs.metadata(), cfs.metadata().regularAndStaticColumns(), EncodingStats.NO_STATS)));
        }
