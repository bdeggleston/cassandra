...
public class RepairJobTest
{
    ...
    public void testNoTreesRetainedAfterDifference() throws Throwable
    {
        ...
        // The session can retain memory in the contained executor until the threads expire, so we wait for the
        // threads that ran the Tree -> SyncTask conversions to die and release the memory
