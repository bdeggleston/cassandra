...
public class LongCompactionsTest
{
    ...
    protected void testCompaction(int sstableCount, int rowsPerSSTable, int colsPerRow) throws Exception
    {
        ...
        new CompactionTask(store, sstables, gcBefore, false, databaseDescriptor, databaseDescriptor.getSystemKeyspace(), databaseDescriptor.getDBConfig(), databaseDescriptor.getStorageService()).execute(null);
    ...
    public void testStandardColumnCompactions() throws IOException, ExecutionException, InterruptedException
    {
        ...
        assertEquals(inserted.size(), Util.getRangeSlice(cfs, databaseDescriptor, databaseDescriptor.getTracing()).size());
